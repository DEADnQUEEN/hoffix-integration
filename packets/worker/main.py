...
from packets.worker import constants
import utils.constants
from utils import hoffix
...
def write_to_excel(filepath: str, data: list[dict[str, any]]) -> None:
    ...
    sh = utils.com_excel.wrap.Sheet(
        [
            utils.com_excel.wrap.Column("A", rename="datetime"),
            utils.com_excel.wrap.Column("B", rename="order_id"),
            utils.com_excel.wrap.Column("D", rename="worker_rename", stop_if_null=False),
            utils.com_excel.wrap.Column("E", rename="state"),
            utils.com_excel.wrap.Column("F", rename="comment", stop_if_null=False),
        ],
        sheet,
    )
